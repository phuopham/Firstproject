                ...
                <div class="owl-carousel team-carousel">
                    <?php foreach ($discounts as $id => $discount) :
                        ...
                        <div class="team-item ">
                            ...
                            <div class="position-relative text-center bg-light rounded px-4 py-5 d-flex flex-column justify-content-between " style="height:32em; margin-top: -100px;">
                                ...
                                <h6 class="text-muted mb-4"><?php echo (substr($discount["description"], 0, 100)) ?></h6>
