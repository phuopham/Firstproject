...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2022 at 01:43 PM
...
VALUES
  ...
  (
    ...
    1,
    'An invigorating, 2-in-1 wash that gently cleanses hair and body. Tones skin with energising Bison Grass and Chinese Galanga. Conditions hair with Provitamin B5. Gentle enough to use each morning and evening. For all hair and skin types, even sensitive skin.\r\nThe uplifting scent of plant essences awakens the senses for a complete fresh feeling. Suitable for all skin and hair types.',
    1,
    0,
    20,
    0,
  ...
  (
    ...
    4,
    'As light as it is comfortable, this intense hydrating bi-phase serum quenches irritated, dull, and uneven skin.\r\nIts secret?\r\nOrganic, medicinal kalanchoe extract, a powerful natural hydration activator that boosts the skin’s hyaluronic acid* production.\r\nIts beauty bonus?\r\nBi-Phase Serum refines the skin’s texture and smooths its surface. Your quenched skin is fresh, comfortable, radiant, and vibrant. For even more hydration, Bi-Phase Serum can be used together with the Hydra-Essentiel cream suitable for your skin type.',
    1,
    0,
    46,
    10,
  ...
  (
    ...
    3,
    'My Clarins new Micellar Cleansing Water gently removes make-up, with Organic golden gentian extract to and smoothen and soften the skin whilst detoxifying and purifying thanks to moringa extract. This product is ideal for micellar water lovers and anyone looking for a refreshing cleanser.',
    1,
    0,
    18,
    0,
  ...
  (
    ...
    'Total Eye Lift',
    5,
    'A new era of our Total Eye Concentrate. This plant-powered, silky gel-cream glides onto the eye area to lift, smooth and brighten from temple to temple. Suitable for sensitive eyes and contact lens wearers.',
    1,
    0,
    59,
    0,
  ...
  (
    ...
    5,
    'Our tightening and depuffing eye concentrate is designed to visibly reduce puffiness around the eyes.\r\nPacked with botanical extracts that reduce puffiness and visibly lift, this innovative eye care delivers a visibly awakened, brighter and bolder look.',
    1,
    0,
    42,
    16,
  ...
  (
    17,
    'Lip Comfort Oil - Limited Edition',
    6,
    'One bottle, one colour, one essential oil and one mood! Lip Comfort Oil is now available in a collection of limited edition mood-boosting shades: which colour will you choose? It&#039;s 4 colours represent 4 mood boosters. Enriched with essential oils for an uplifting, soothing, relaxing or mood-lifting effect, it guarantees shine, nourishment, comfort and great make-up results: both natural and with a glossy finish.\r\nFormula enriched with 93% ingredients of natural origin, including an ultra-nourishing trio of plant-based oils containing organic rose hip oil—which helps strengthen the barrier function and thus protect against external aggressors—as well as organic jojoba and hazelnut.',
    1,
    0,
    20,
    0,
  ...
  (
    ...
    10,
    'A melting, nourishing stick with a unique texture offering the intense shine of a liquid lacquer and simple application.',
    1,
    0,
    23,
    5,
  ...
  (
    ...
    12,
    'Instead of a cat-eye, what about a doe-eyed or a graphic look? The Graphik Ink eyeliner allows women to let their personalities run wild: its precise, easy-to-use felt tip makes it easy to create any type of line.\r\nThis new liner combines a perfect line and is intense black thanks to its pure “carbon black” pigments: they catch the light and provide a denser colour.  An ultra-intense look all the time.\r\nThis infallible, transfer-proof, long-wear eyeliner defines your eyes for hours on end:  your liner stays clean and sharp all day long!',
    1,
    0,
    22,
    0,
...
ALTER TABLE
  `products`
ADD
  CONSTRAINT `products_ibfk_1` FOREIGN KEY (`catalogID`) REFERENCES `catalogs` (`catalogID`),
ADD
