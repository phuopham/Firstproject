...
VALUES
  ...
  (
    26,
    'Hand &amp; Treatment Treatment Cream',
    9,
    'How do I care for dehydrated skin using body moisturisers? Dehydrated skin on your body shows signs of dryness and feels tight. The only way to relieve this discomfort is to make up for a loss of moisture. After bathing or showering, apply body lotion straight away for soft, supple skin, a far cry away from dry skin lacking nourishment. Don&#039;t forget to exfoliate your body every week to get a gorgeous glow: The Clarins range of body exfoliators offers a selection of exfoliators to suit even the most sensitive of skin types.',
    1,
    0,
    30,
    12,
  ...
  (
    28,
    'Clarins After Sun Refreshing After Sun Gel - For Face &amp; Body',
    16,
    'Fresh, non-greasy &amp; non-sticky gel texture penetrates instantly into skin.Enriched with botanical extracts &amp; anti-oxidants to quench sun damaged skin with refreshing coolness.Soothes &amp; moisturizes skin for 24 hours.Protects against free-radical damage while regenerating skin.Beautifies, extends &amp; intensifies tans.Infused with a pleasant scent that reminds you of the sun &amp; holidays.Leaves skin calm, soothed &amp; comfortable.Perfect for all skin types.',
    1,
    0,
    26,
    12,
  ...
  (
    ...
    ' Hypnose Cologne',
    18,
    'Hypnose by Lancome Cologne. If you&#039;re looking for a classic scent that you can wear to the office and to evening affairs, dab on a little Hypnose. This traditional men&#039;s fragrance from Lancome was introduced in 2007 as an all-around option for men who value originality. High notes are of cardamom and mint make for a refreshing experience in the morning. As the day wears on, the deep citrus notes of bergamot and mandarin orange are boldly complemented by earthy patchouli.',
    4,
    0,
    21,
    0,
  ...
  (
    30,
    'Mac Retro Matte Lipstick Rouge À Lèvres',
    10,
    'Mac Retro Matte Lipstick Rouge À Lèvres 3g is the latest lipstick line of the worldwide famous cosmetic brand M.A.C. Matte lipstick contains nourishing ingredients, no shine, no emulsion, will not feel dry lips. This line was born to help improve very dry lips.',
    5,
    0,
    34,
    0,
  ...
  (
    ...
    'M.A.C Stack Mascara',
    13,
    'This never-before-seen continuously buildable, clump-resistant formula gives you customizable gravity-defying volume from natural to next-level, along with instant lash lift and length.',
    5,
    0,
    26,
    3,
  ...
  (
    ...
    4,
    'Kiehl&#039;s Clearly Corrective Dark Spot Solution Serum comes in a transparent glass bottle where the essence is visible. Serum has two types of capacity to choose from: large size 50ml, small size 30ml. The product has a dropping nozzle to control the dosage, convenient and easy to use.',
    6,
    0,
    28,
    11,
  ...
  (
    ...
    14,
    'MAC Liquid Concealer conceals imperfections on the face such as dark circles, acne, freckles and uneven skin tone, but still retains a natural look thanks to its thin and light texture. The special formula of the product helps to prolong the coverage time on the skin up to 15 hours.',
    5,
    0,
    24,
    0,
  ...
  (
    35,
    'MAC Candy Yum-Yum Shadescents Eau de Parfum ',
    17,
    'MACCosmetics is launching its new collection of fragrances at the end of November 2016. The newMACShadescents collection is inspired by and named after the legendary shades ofMAClipsticks. Six fragrances  named Creme De Nude  Velvet Teddy  Ruby Woo  Lady Danger  My Heroine andCandy Yum-Yum  are aiming to project the style and vibe of the shades. ',
    5,
    0,
    33,
    2,
  ...
  (
    36,
    'BIODERMA SEBIUM CLEANSING CLEANSING GEL',
    3,
    'Sebium Foaming Gel A foaming gel cleanser that perfectly cleans and cleanses the skin. Without alcohol or color, Sebium Foaming Gel can be used as a shaving gel! Sébium Foaming Gel contains exclusive patented Fluidactiv, biologically regulates sebum quality, keeps sebum thickened and clogs pores Soap-free, colorant-free, alcohol-free, alcohol-free parabens and hypoallergenic.',
    3,
    0,
    20,
    0,
  ...
  (
    ...
    'Bioderma Hydrabio',
    4,
    'Bioderma Hydrabio product line is a very famous product line in the field of &quot;treatment&quot; of dehydrated, dehydrated skin, currently standing in the TOP of the best products for skin in France, TOP of the good products. Best for sensitive skin voted on Makeupalley. This is a line dedicated to the hydration needs of the skin that has created a fever in the beauty community and received many compliments from reputable beauty bloggers.',
    3,
    0,
    22,
    6,
  ...
  (
    38,
    'L&#039;Absolu Rouge Ruby Cream Long-Lasting Lipstick',
    10,
    'Trendy earthy orange lipstick tone, this super western tone is always the first choice of girls who are at the forefront of the trend. Lancome 274 Coeur De Rubis lipstick is not only beautiful in every beautiful lipstick color, but also has Lancome&#039;s improved super soft lipstick for plump and healthy lips that look seductive.',
    4,
    0,
    35,
    2,
  ...
  (
    ...
    '3CE Velvet Lip Tint',
    10,
    'Lipstick product from Korean cosmetic brand 3CE, has a smooth creamy texture like mousse, and is a unique combination of matte lipstick and tint, so the lipstick is extremely thin and light. It feels heavy on the lips like other matte lipsticks, with a sweet vanilla scent.',
    2,
    0,
    28,
    0,
  ...
  (
    40,
    'Keilh’s Superbly Restorative Argan Body Lotion',
    9,
    'As a lotion, but its texture is thick, almost creamy, white, smooth. The scent is extremely relaxing, after the cream is absorbed all over the body, it is like a thin, moist, fragrant film wrapped around the body.',
    6,
    0,
    29,
    0,
